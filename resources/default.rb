...
property :post_install_action, String, default: 'kill'
...
property :install_timeout, Integer, default: 600
...
property :upgrade_delay, Integer, default: 60
property :product_name, String, default: 'chef'
property :rubygems_url, String, default: lazy { Chef::Config[:rubygems_url] }
property :handle_zip_download_url, String, default: 'https://download.sysinternals.com/files/Handle.zip'
property :event_log_service_restart, [true, false], default: true
property :install_command_options, Hash, default: {}
